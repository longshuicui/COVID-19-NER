...
flags.DEFINE_float("num_train_epochs", 13.0, "Total number of training epochs to perform.")
...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    blstm_crf = BLSTM_CRF(embedded_chars=embedding, hidden_unit=512, cell_type="lstm",
                          num_layers=2,
